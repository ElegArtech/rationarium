...
## Complément RM-13 — parents de A-43

Le 10 septembre 2026, D-RM-08 lève l’indétermination de A-43. La table normative « Filtres et retour depuis une fiche » ajoutée au brief `cadrage/02` donne le parent de chaque vue 06–35. A-43 devient une famille d’arêtes concrètes : 11→10 ; 12/13/14/15→11 ; 17→16 par défaut ou liste source conservée ; 24→23 ; 26→25 ; 28→27 ; autres vues de coquille→06. Aucune arête 06→06. Les permissions restent exigées et un parent interdit retombe sur 06. A-66 conserve l’URL de liste source, dont ses filtres, et prend 16 pour un accès direct. Cette précision est une décision de conception, pas un constat déduit du routeur actuel.
