...
const SANS_CLIENT: { verbe: string; chemin: string; raison: string }[] = [
  ...
  { verbe: "DELETE", chemin: "/administration/roles/:id", raison: A_BRANCHER },
  ...
  { verbe: "POST", chemin: "/documents", raison: A_BRANCHER },
  ...
  { verbe: "PATCH", chemin: "/documents/commentaires/:id", raison: A_BRANCHER },
  { verbe: "DELETE", chemin: "/documents/commentaires/:id", raison: A_BRANCHER },
  ...
  { verbe: "POST", chemin: "/projets/:id/annuler", raison: A_BRANCHER },
  { verbe: "POST", chemin: "/projets/:id/instantane", raison: A_BRANCHER },
  { verbe: "POST", chemin: "/taches/:id/deplacer", raison: A_BRANCHER },
  { verbe: "GET", chemin: "/taches/:id/incoherences", raison: A_BRANCHER },
  { verbe: "GET", chemin: "/teletravail/statistiques", raison: A_BRANCHER },
